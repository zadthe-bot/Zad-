        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Log in to order.', style: TextStyle(color: AppColors.blackSoft)),
              ...
              Center(
                child: TextButton(
                  ...
                  child: const Text.rich(TextSpan(
                    children: [
                      TextSpan(text: 'No account? ', style: TextStyle(color: AppColors.blackSoft)),
                      TextSpan(text: 'Sign up', style: TextStyle(color: AppColors.orange, fontWeight: FontWeight.w600)),
                    ],
                  )),
                ),
              ),
